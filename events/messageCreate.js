module.exports = (client, message) => {
    ...
    if (cmd && cmd.voiceChannel) {
        ...
        if (message.guild.me.voice.channel && message.member.voice.channel.id !== message.guild.me.voice.channel.id) return message.channel.send(`Não estamos no mesmo canal de voz. ❌`);
    }
